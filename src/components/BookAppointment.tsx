...
const BookAppointment: React.FC<BookAppointmentProps> = ({ contactId, tenantId }) => {
  ...
  const bookAppointment = useCallback(async () => {
    ...
    try {
      ...
      const storedAppointments = await DataService.getTenantAppointments(tenantId);
      await DataService.updateTenantAppointments(tenantId, [...storedAppointments, appointment]);
